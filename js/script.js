$(document).ready(function(){
	...
	$('.flextext').click(function(){
		...
		,600
		,"swing");
		$('.verticaltext1').css({"left":"8%","top":"39%"});
		
		$('.verticaltext1,.verticaltext2,.verticaltext3,.verticaltext4,.verticaltext5,.verticaltext6,.verticaltext7,.verticaltext8').css({"font-size":"24px"});
